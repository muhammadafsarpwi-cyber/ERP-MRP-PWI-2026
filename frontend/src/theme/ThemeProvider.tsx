    ...
    return {
      ...
      components: {
        ...
        Table: {
          ...
          rowHoverBg: dark ? rgbaFromHex(roles.accent, 0.1) : rgbaFromHex(roles.primary, 0.04),
          rowSelectedBg: dark ? rgbaFromHex(roles.accent, 0.18) : rgbaFromHex(roles.primary, 0.09),
          rowSelectedHoverBg: dark ? rgbaFromHex(roles.accent, 0.22) : rgbaFromHex(roles.primary, 0.12),
          cellPaddingBlock: 10,

...
const SEEDED_VIEW_PERMISSIONS: string[] = [
  ...
  'item.view', 'item_category.view', 'item_route_type.view', 'item_type.view', 'uom.view', 'uom_conversion.view',
...
const DISCOVERED_ROUTES: string[] = [
  ...
  '/hr/dashboard', '/hr/my-attendance', '/hr/attendance-register', '/hr/shift-roster',
  '/hr/live-map', '/hr/leaves', '/hr/regularizations', '/hr/overtime-approval',
  '/hr/advances', '/hr/employee-documents', '/hr/attendance-exceptions',
  '/hr/payroll', '/hr/final-settlement', '/hr/employees',

...
export const NAV_ENTRIES: NavEntry[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { key: '/hr/regularizations', label: 'Regularizations', icon: EditOutlined, color: 'purple', permissions: ['hr.attendance.view'] },
      { key: '/hr/overtime-approval', label: 'Overtime Approval', icon: FieldTimeOutlined, color: 'purple', permissions: ['hr.attendance.view'] },

...
export const NAV_ENTRIES: NavEntry[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { key: '/hr/shift-roster', label: 'Shift Roster', icon: ScheduleOutlined, color: 'purple', permissions: ['hr.attendance.view'] },
      { key: '/hr/live-map', label: 'Live Map', icon: EnvironmentOutlined, color: 'purple', permissions: ['hr.attendance.view'] },

...
-- Does NOT duplicate stock balances, stock ledger, or item master.
-- Reuses existing inventory engine for all stock movements.
...
-- =====================================================
-- 2. STORE ITEMS (relationship between store and item)
-- =====================================================
...
-- Material Receipts (reuse existing goods_receipts with store context)
